...
@implementation SLSquareL
- (instancetype)initWithStartIndex:(NSInteger)startIndex {
    if (self = [super initWithStartIndex:startIndex]) {
        self.indexArray = @[@(startIndex), @(startIndex + 10), @(startIndex + 20),  @(startIndex + 21)].mutableCopy;
        self.maxSteps = 17;
...
- (void)randomSquare {
    ...
    if (self.currentSquareType == 0) {
        self.indexArray = @[@(startIndex + 10), @(startIndex + 11), @(startIndex + 12),  @(startIndex + 2)].mutableCopy;
        self.maxSteps = 18;
        self.checkBottomArray = @[@0, @1, @2];
        self.checkLeftArray = @[@0, @3];
        self.checkRightArray = @[@2, @3];
        self.currentSquareType = 1;
    } else if (self.currentSquareType == 1) {
        self.indexArray = @[@(startIndex - 10), @(startIndex - 9), @(startIndex + 1),  @(startIndex + 11)].mutableCopy;
        self.maxSteps = 17;
        self.checkBottomArray = @[@0, @3];
        self.checkLeftArray = @[@0, @2, @3];
        self.checkRightArray = @[@1, @2, @3];
        self.currentSquareType = 2;
    } else if (self.currentSquareType == 2) {
        self.indexArray = @[@(startIndex + 10), @(startIndex), @(startIndex + 1),  @(startIndex + 2)].mutableCopy;
        self.maxSteps = 18;
        ...
        self.indexArray = @[@(startIndex - 10), @(startIndex), @(startIndex + 10),  @(startIndex + 11)].mutableCopy;
        self.maxSteps = 17;
        self.checkBottomArray = @[@2, @3];
        self.checkLeftArray = @[@0, @1, @2];
        self.checkRightArray = @[@0, @1, @3];
